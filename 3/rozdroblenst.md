...
1. Система престолонаслідування. На Русі так і не закріпилася жодна із схем спадкування, що їх намагалися вводити князі. Як «горизонтальна», так і «вертикальна» схеми мали свої недоліки. Проте ці принципи змішалися і кожен міг трактувати своє право на престол
(великий чи удільний) як йому буде завгодно. У результаті –
нескінченний каталізатор[^6] міжусобних війн.

* Територія та етнічний склад. На початок ХІІ ст. Русь все ще була
...
<question>
	...
	<answer>вертикального престолонаслідуваня</answer>
        <answer correct>із комбінацій горизонтальної та вертикальної, котру трактували, вихлдячи із особистої вигоди</answer>
...
<question>
	<p>Після 1132 року</p>
        <answer>утворилося близько 15 удільних князівств, які незмінно існували у своїх кородонах більше століття</answer>
